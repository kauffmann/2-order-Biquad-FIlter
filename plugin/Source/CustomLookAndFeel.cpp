...
CustomLookAndFeel::CustomLookAndFeel() {
  setColour(juce::ComboBox::textColourId, getColor(Colors::labelText));
  setColour(juce::Label::textColourId, getColor(Colors::labelText));
  const juce::Colour darkBlue{0xFF153245};
  setColour(juce::PopupMenu::backgroundColourId, darkBlue);
  setColour(juce::PopupMenu::textColourId, getColor(Colors::labelText));
  setColour(juce::PopupMenu::highlightedTextColourId, juce::Colour{0xFF0C131E});
  setColour(juce::PopupMenu::highlightedBackgroundColourId,
            getColor(Colors::paleBlue));
